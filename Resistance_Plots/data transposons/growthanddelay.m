...
for i=1:8 
    for j=1:12
        ...
        o2=o1+1.2; %log OD at time drug added
        
        % manual corrections
        if(i==4 && j==6) o2=o1+0.9; end
        if(i==7 && j==6) o2=o1+0.9; end
        ...
        if ~isempty(i2) 
            ...
            % manual corrections
            if(i==5 && j==7) o3=o2; end
            if(i==8 && j==7) o3=o2; end
            if(i==4 && j==6) o3=o2; end
            if(i==7 && j==6) o3=o2; end
            if(i==6) o3=o2+0.1; o4=o2+0.8; end
            if(i==2) o3=o2+0.1; o4=o2+0.8; end
        ...
        if(i==1 && j==1) figure; end
        subplot(8,12,(i-1)*12+j)
        plot(t,v,'b')
        hold on
        plot([t_drug t_drug],[-3.6 -0.3],'--k','LineWidth',1)
        plot(data.time,log2(squeeze(data.data(:,1,i))),'--k','LineWidth',2)
