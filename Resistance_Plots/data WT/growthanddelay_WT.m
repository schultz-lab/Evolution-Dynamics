function M_WT=growthanddelay_WT(data,t_drug)
% t_drug is time the drug was added in minutes

M_WT=NaN(12,2); % delay, growth
M_WT(:,2)=0;

names={'Dyn-1','Dyn-1 \DeltaTetR \DeltaAcrR','Dyn-2','Dyn-2 \DeltaTetR','Dyn-3','Dyn-3 \DeltaTetR'};
